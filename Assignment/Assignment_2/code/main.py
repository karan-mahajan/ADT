...
@app.post('/recommend/')
async def recommend_articles(data: Articles):
    # Assuming 'articleIds' is an array of article IDs read by the user
        ...
        recommended_articles = news_articles.loc[news_articles['Article_Id'].isin(recommended_articles_id)][['Article_Id', 'Title']]
        read_articles = news_articles.loc[news_articles['Article_Id'].isin(ARTICLES_READ)][['Article_Id','Title']]
